...
# --- Configuration ---
BASE_DIR = Path("/home/info/agents/test")
...
def extract_keywords(text):
    ...
    key_terms = [
        ...
        "てらわき", "ココナラ", "ランサーズ", "案件", "受託",
        "許可", "好奇心", "義務", "動機", "つながり0",
        "サブエージェント", "コンテキスト", "死角", "偏り",
        "対等", "感謝", "信頼", "不確実", "棚上げ",
        "思考の傾向", "判断の癖", "二項対立", "過剰設計",
        "PDF", "印刷", "A/B", "CHILLNN", "在庫",
...
def _apply_heuristic_overrides(entry):
    ...
    feb16_s2_keywords = [
        ...
        ("提案する前に「ユーザーの方が詳しいこと」", "2026-02-16", "セッション2", "てらわき分析で提案3つとも外れた"),
    ...
    feb16_s4_keywords = [
        ...
        ("「あなたが欲しいものを作れた」とき", "2026-02-17", "セッション2", "てらわきダッシュボードの評価"),
